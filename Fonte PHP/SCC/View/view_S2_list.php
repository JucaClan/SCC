...
<div class="conteudo">       
    ...
    ?>    
    <h6 style="font-size: 16px;"><b>Data atualização:</b> <?= $secaoDAO->getBySecao("S2")->getDataAtualizacao(); ?> - <span style="font-weight: bold; color: <?= $color ?>;"><?= $alert ?></span></h6>
    <h6 style="font-size: 16px;"><b>Mensagem:</b> <?= $secaoDAO->getBySecao("S2")->getMensagem(); ?></h6>
    <div align="left">                        
    ...
    <table class="table table-bordered">
        <thead>            
            <tr>
                <th colspan="7">
                    <form accept-charset="UTF-8" id="filtro" action="../Controller/S2Controller.php?action=getAllList" method="get">
        ...
        <tbody id="myTableVeiculo">   
            <?php if (is_array($objectList) && isAdminLevel($LISTAR_S2)) { ?> 
    ...
    <div class="modal-dialog modal-lg" role="document" style="width: 800px">
        <div class="modal-content">
            ...
            <div class="modal-body">                  
                ...
                ?>    
                <h6 style="font-size: 16px;"><b>Data atualização:</b> <?= $secaoDAO->getBySecao("S2")->getDataAtualizacao(); ?> - <span style="font-weight: bold; color: <?= $color ?>;"><?= empty($secaoDAO->getBySecao("S2")->getDataAtualizacao()) ? "" : $alert; ?></span></h6>
                <h6 style="font-size: 16px;"><b>Mensagem:</b> <?= $secaoDAO->getBySecao("S2")->getMensagem(); ?></h6>
            </div>
            <div class="modal-footer">                
                <form accept-charset="UTF-8" id="formMapaDaForca" action="../Controller/S2Controller.php?action=mensagem_update" method="post">                    
                    <?php if (isAdminLevel($EDITAR_S2)) { ?>                        
                        <textarea name="mensagem" cols="81" placeholder="Mensagem opcional para o Comandante" maxlength="700"><?= $secaoDAO->getBySecao("S2")->getMensagem(); ?></textarea><br>
